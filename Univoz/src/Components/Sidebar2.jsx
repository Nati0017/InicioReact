                    ...
                    <nav className="sidebar2" >
                        <div className="card sidebar-der mb-2">
                            <div className="card-body ">
                                <h5 className="card-title"><i className="fa-regular fa-star"></i> Neurodiversidad</h5>
                                <ul>
                                    <li>
                                ...
                                <h5 className="card-title"><i className="fa-regular fa-star"></i> Neurodivergencia</h5>
                                <ul>
                                    <li>
